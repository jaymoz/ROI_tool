...
def active_learning1():
    ...
    addOutputToExcel(df_Analysis,"\nAnalysis of  Label Classification  : \n")

    #updateResults(df_rqmtComb,args)   #Update Results in excel....
...
def learnTargetLabel(args):
    ...
    while True:
        ...
        for i in range(9):
            ...
            countVectorizer, tfidfTransformer, classifier, classifierTestScore = createClassifier(args.loc[0,'classifier'],df_training,resamplingTechnique)  
            ...
            #-----------------------------------------LM starts-------------------------------------------
            LM_countVectorizer, LM_tfidfTransformer, LM_classifier, LM_classifierTestScore= createClassifier(args.loc[0,'classifier'],df_LM_training,resamplingTechnique)
        ...
        df_finalPredictions, df_remaining_Testing = analyzePredictions(args,df_predictionResults)
...
def createClassifier(clf,df_trainSet,resampling_type):
    ...
    #Ensemble Creation
        ...
        fit(X_train_tfidf,np.array(y_train).astype('int'))
